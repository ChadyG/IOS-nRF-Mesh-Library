//
//  GenericAdminPropertyStatus.swift
//  nRFMeshProvision
//
...
public struct GenericAdminPropertyStatus: GenericMessage {
    public static var opCode: UInt32 = 0x4A
    ...
    /// Creates the Generic Admin Property Status message.
    ///
